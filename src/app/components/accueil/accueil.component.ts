...
export class AccueilComponent implements OnInit {
  ...
  selectedCategory: string = 'Concert'; // Catégorie par défaut sélectionnée
  ...
  filterEventsByCategory(category: string): Evenement[] {
    if (!category) {
      return this.event; // Retourner tous les événements si aucune catégorie n'est sélectionnée
    }
    return this.event.filter(ev => ev.category.category === category);
  }
